  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-white/10">
        <div
          className="w-9 h-9 rounded-xl flex items-center justify-center text-white font-bold text-sm text-display shrink-0"
        ...
        <div>
          ...
          <p className="text-xs" style={{ color: 'rgba(255,255,255,0.45)' }}>Admin Panel</p>
        </div>
      </div>

      {/* Nav */}
      <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        <p className="px-4 py-2 text-xs font-semibold uppercase tracking-widest" style={{ color: 'rgba(255,255,255,0.3)' }}>
          Menu
        </p>
        {NAV_ITEMS.map((item) => (
          <NavLink
      ...
      <div className="px-3 py-4 border-t border-white/10">
        <div className="flex items-center gap-3 px-4 py-3 rounded-xl" style={{ background: 'rgba(255,255,255,0.05)' }}>
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs truncate" style={{ color: 'rgba(255,255,255,0.45)' }}>Administrator</p>
          </div>
          <button
